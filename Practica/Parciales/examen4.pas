...
procedure alta (var arc: archivo; registro: dato);		//Se recibe un registro
var
	aux, regArc: dato;
begin
	reset(arc);
...
var
	...
	registro: dato;
BEGIN
	recibirArc(arc);									//Se dispone y se asigna
	alta(arc, registro);								//Se recibe el registro a dar de alta
	baja(arc, registro);								//Se recibe el registro a dar de baja
END.
